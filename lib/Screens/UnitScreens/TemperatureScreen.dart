...
class _TemperatureScreenState extends State<TemperatureScreen> {
  String _unit1 = 'Deg Celsius (°C)';
  String _unit2 = 'Deg Fahrenheit (°F)';
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                ...
                Color.fromARGB(255, 200, 240, 255),
              ],
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient:LinearGradient(
                    tileMode: TileMode.decal,
                    colors: [
                      Color.fromARGB(255, 173, 216, 230), // Light blue (cool)
                      Color.fromARGB(255, 255, 239, 192), // Light yellow (warm) Cool blue (cold)
                    ],
                    begin: Alignment.topCenter,
                    end: Alignment.bottomCenter,
                  ),
                        ...
                        Padding(
                            ...
                            child: PopupMenuButton<String>(
                              ...
                              itemBuilder: (BuildContext context) {
                                return convertList
                                    .where((str) => str != 'Temperature') // Filter out the current screen
                                    .map((str) {
                              ...
                              color: const Color.fromARGB(255, 185, 250, 250),
                              elevation: 5,
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  children: [
                                    Text(
                                      'Temperature', // Display the current screen name
                                      style: TextStyle(
                                        fontSize: 30,
                                        color: Colors.black,
                                      ),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(
                                  color: Color.fromARGB(255, 185, 250, 250),
                                  width: 2.0,
                                ),
                              ),
                            ),
