...
class _VolumeScreenState extends State<VolumeScreen> {
  String _unit1 = 'Meter C (m\u00B3)';
  String _unit2 = 'Liter (lt)';
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 150, 210, 240),
                Color.fromARGB(255, 100, 181, 232),
              ],
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient:LinearGradient(
                    tileMode: TileMode.decal,
                    colors: [
                      Color.fromARGB(255, 100, 181, 232), // Lighter Blue
                      Color.fromARGB(255, 135, 206, 235), // Light Sky Blue
                        ...
                        Padding(
                            ...
                            child: PopupMenuButton<String>(
                              ...
                              itemBuilder: (BuildContext context) {
                                return convertList
                                    .where((str) => str != 'Volume') // Filter out the current screen
                                    .map((str) {
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  children: [
                                    Text(
                                      'Volume', // Display the current screen name
                                      style: TextStyle(
                                        fontSize: 30,
                                        color: Colors.black,
                                      ),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(
                                  color: Color.fromARGB(255, 100, 181, 232),
                                  width: 2.0,
                                ),
                              ),
                            ),
