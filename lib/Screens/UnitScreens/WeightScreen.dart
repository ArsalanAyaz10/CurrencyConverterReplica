        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 240, 240, 240), // Very light gray
                Color.fromARGB(255, 220, 220, 220), // Light gray
              ],
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient:LinearGradient(
                    colors: [
                      Color.fromARGB(255, 220, 220, 220), // Light gray
                      Color.fromARGB(255, 192, 192, 192), // Medium gray
                        ...
                        Padding(
                            ...
                            child: PopupMenuButton<String>(
                              ...
                              itemBuilder: (BuildContext context) {
                                return convertList
                                    .where((str) => str != 'Weight') // Filter out the current screen
                                    .map((str) {
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  children: [
                                    Text(
                                      'Weight', // Display the current screen name
                                      style: TextStyle(
                                        fontSize: 30,
                                        color: Colors.black,
                                      ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              menuMaxHeight: 230,
                              value: _unit1,
                              dropdownColor: const Color.fromARGB(255, 220, 220, 220),
                              elevation: 0,
                              isDense: false,
